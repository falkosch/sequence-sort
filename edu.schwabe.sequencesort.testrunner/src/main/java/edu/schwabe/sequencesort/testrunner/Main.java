...
final class Main {
	...
	ServiceLoader.load(Algorithm.class).forEach(algorithmUnderTest -> Main.runTest(algorithmUnderTest, report));
    }

    private static void runTest(final @NonNull Algorithm algorithmUnderTest, @NonNull final Reporter report) {
