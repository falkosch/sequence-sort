...
import edu.schwabe.sequencesort.api.OperationReport;
import edu.schwabe.sequencesort.api.OperationResult;
import edu.schwabe.sequencesort.api.Reporter;
import edu.schwabe.sequencesort.api.SortedProperty;

public final class TextReporter implements Reporter {

    @Override
    public void display(final @NonNull Class<? extends Algorithm> algorithmUnderTestClass,
    ...
    private static void display(final @NonNull OperationResult<int @NonNull []> operationResult, final int trial,
	    final long duration) {
	...
	System.out.printf("\tTrial %1$d with n=%2$d elements: array is %3$s\n", Integer.valueOf(trial), Long.valueOf(n),
		isSortedQualifier);
    ...
    private static String makeIsSortedQualifier(final @NonNull OperationResult<int @NonNull []> operationResult) {
    ...
    private static void printMetric(final String metricName, final String metricVariableName,
